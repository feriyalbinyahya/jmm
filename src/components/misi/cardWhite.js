...
const CardWhite = ({ judul, expired_date, kategori, id, navigation, publish_date, is_important, deskripsi}) => {
  return (
    <Box shadow={0} style={styles.cardContainer}>
        <View style={{borderRadius: 6, backgroundColor: Color.neutralZeroOne}}>
