...
const EditSimpatisan = ({navigation, route}) => {
    ...
    const [capres, setCapres] = useState(Capres);
    const [idCapres, setIdCapres] = useState(0);
    const [alasanSuka, setAlasanSuka] = useState(AlasanSuka);
    const [isModalVisibleTidakSuka, setIsModalVisibleTidakSuka] = useState(false);
    const [capresTidakSuka, setCapresTidakSuka] = useState(CapresTidakSuka);
    const [idCapresTidakSuka, setIdCapresTidakSuka] = useState(0);
    const [alasanTidakSuka, setAlasanTidakSuka] = useState(AlasanTidakSuka);
    ...
    const handleLanjutkan = () => {
      setIsLoading(true);
      SimpatisanServices.updateSimpatisan(id,{
      ...
      .then(res=> {
        ...
        if(res.data.message == "Sukses update data simpatisan."){
